  ...
  return (
    <div>
      <div className="mx-auto">
        <Breadcrumb pageName="Account Detail" />
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mt-6.5">
                <h3 className="text-md text-black font-bold">Tweets</h3>

                <div data-theme="light" className="h-[250px]">
                  <Tweet id="1755736455354142970" />
                </div>
              </div>
            </div>
          </div>
